...
include 'config.php';
$query = "SELECT * FROM leaves WHERE userid='".$_SESSION['userid']."'  ";
...
if(!$row){
  ...
  <a href="fill_leave.php" class="backk-to-top"><i class="fa fa-plus"></i></a>
  </div>
  </div>';
 ...
 <table class="table ">
  ...
  foreach($result as $row){
      ...
      <td>'; if($row['no_of_days'] == 0){
        echo '<small><strong>--</strong></small>';
     } else {
       echo $row['no_of_days'];  
     }
      echo '<td>'; if($row['session']== 'Choose..'){
        echo '<small><strong>--</strong></small>';
     } else {
       echo $row['session'];  
     }
...
<div class="col-lg-8">
<h3><b>Remaining CL : </b><small>12</small></h3>
</div>
<div class="col-lg-8">
<h3><b>Remaining RH : </b><small>12</small></h3>
</div>
</div>
</div>
</div>
...
function getid(e){
  ...
  window.location.href="edit_leave.php?w1=" +id ;
}
