...
if(isset($_POST['btn'])){
  ...
  if($filename == ''){
    $query = "INSERT INTO invite_talks(userid,title,from_date,to_date,agency,year,place) VALUES('".$_SESSION['userid']."','$name','$from_date','$to_date','$agency','$year','$place')";
    $result = $conn->query($query);
  } else {
    $query = "INSERT INTO invite_talks(userid,title,from_date,to_date,agency,file,year,place) VALUES('".$_SESSION['userid']."','$name','$from_date','$to_date','$agency','$filename','$year','$place')";
    $result = $conn->query($query);
...
<a href="welcome.php">&nbsp;&nbsp;&nbsp;&nbsp;<i style="color:white;"  class="fas fa-home"></i></a>
          <h3><a href="invite_talks.php"><i style="color:white;"  class="fas fa-arrow-alt-circle-left"></i></a>&nbsp; Invite Talks Details</h3>
  ...
  <div class="form-row">
    ...
    <input type="text" name="name" class="form-control" id="inputEmail4" placeholder="title" required>
    </div>
  </div>
