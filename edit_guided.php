...
include 'config.php';
$id = $_GET['w1'];
$q = "SELECT * FROM guided WHERE id='$id' ";
$res =  $conn->query($q);
$row = $res->fetch_assoc();
if(isset($_POST['btn'])){
    $name = $_POST['name'];
  ...
  $query = "UPDATE guided SET name='$name',degree='$degree',year='$year',no_of_stud='$no_of_stud' WHERE id='$id'";
...
<header class="section-header">
          <h3><a href="guided.php"><i style="color:white;"  class="fas fa-arrow-alt-circle-left"></i></a>&nbsp; Edit Guided projects Details</h3>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
    <input type="number" name="no_of_stud" value="<?php echo $row['no_of_stud']; ?>" class="form-control" id="inputEmail4" >
    </div>
  </div>
