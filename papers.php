...
include 'config.php';
$query = "SELECT * FROM papers WHERE userid='".$_SESSION['userid']."' ORDER BY year DESC ";
...
if(!$row){
    ...
    <div class="top_navbar">
     ...
     <li class="nav-item dropdown">
       ...
       <ul class="dropdown-menu" >
       <li>  <a style="color:blue;" class="dropdown-item" href="#">Papers / Publications</a></li>
  ...
  <div class="container text-center"><h2>You have no records!..Please fill your Paper details</h2>
  </div>
  <a href="fill_papers.php" class="backk-to-top"><i class="fa fa-plus"></i></a>
  </div>
  </div>';
} else {
   echo '<div class="wrapper">
 ...
 <table class="table ">
  ...
  foreach($result as $row){
     ...
     echo $row['indexing'];  
      ...
      echo '<td>'; if($row['file']== ''){
         echo '<small><strong>No files found</strong></small>';
      } else {
...
<a data-toggle="modal" data-target="#exampleModal" href="#" class="btn btn-primary" >Want to fetch paper details during specific period?</a>
</div></div></div>
</div>
';
...
function getid(e){
  ...
  window.location.href="edit_papers.php?w1=" +id ;
}

function getdata(){
  var from_date = document.getElementById('from_date').value;
  var to_date = document.getElementById('to_date').value;
  window.location.href="fetch_papers.php?w1=" +from_date+"&w2=" +to_date ;
}
