...
include 'config.php';
$query = "SELECT * FROM guided WHERE userid='".$_SESSION['userid']."' ORDER BY year DESC ";
...
if(!$row){
    ...
    <div class="top_navbar">
      ...
      <div class="top_menu">
        <div class="logo">Guided Projects</div>
        <!-- <ul>
          <li><a href="#">
     ...
     <ul>
       ...
       <ul class="dropdown-menu" >
         <li><a style="color:black;" class="dropdown-item" href="#" class="active">Guided Projects</a></li>
  ...
  <a href="fill_guided.php" class="backk-to-top"><i class="fa fa-plus"></i></a>
  </div>
  </div>
  ';
} else {
   ...
   <div class="top_navbar">
    ...
    <ul>
      ...
      <ul class="dropdown-menu" >
        <li><a style="color:blue;" class="dropdown-item" href="#" >Guided Projects</a></li>
        <li><a style="color:black;" class="dropdown-item" href="funded.php">Funded Projects</a></li>
 ...
 <table class="table ">
  ...
  foreach($result as $row){
      ...
      <td><button class="btn btn-info" data-id='.$row['id'].' onclick="getid(this)">Edit</button> 
    </tr>';
  }
...
<a data-toggle="modal" data-target="#exampleModal" href="#" class="btn btn-primary" >Want to fetch guided project details during specific period?</a>
</div></div></div>
</div>
';
...
<head>
    ...
    <title>Guided Projects | CSE</title>
...
function getid(e){
  ...
  window.location.href="edit_guided.php?w1=" +id ;
}

function getdata(){
  var from_date = document.getElementById('from_date').value;
  var to_date = document.getElementById('to_date').value;
  window.location.href="fetch_guided.php?w1=" +from_date+"&w2=" +to_date ;
}
