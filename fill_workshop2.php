...
if(isset($_POST['btn'])){
  ...
  if($filename == ''){
    $query = "INSERT INTO workshops2(userid,title,from_date,to_date,agency,year) VALUES('".$_SESSION['userid']."','$name','$from_date','$to_date','$agency','$year')";
    $result = $conn->query($query);
  } else {
    $query = "INSERT INTO workshops2(userid,title,from_date,to_date,agency,file,year) VALUES('".$_SESSION['userid']."','$name','$from_date','$to_date','$agency','$filename','$year')";
    $result = $conn->query($query);
...
<a href="welcome.php">&nbsp;&nbsp;&nbsp;&nbsp;<i style="color:white;"  class="fas fa-home"></i></a>
          <h3><a href="workshops2.php"><i style="color:white;"  class="fas fa-arrow-alt-circle-left"></i></a>&nbsp; Conducted workshop Details</h3>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
    <input type="text" name="agency" class="form-control" id="inputEmail4" placeholder="Sponsored Agency/Institution Name">
    </div>
  </div>
