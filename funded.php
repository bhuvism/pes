...
include 'config.php';
$query = "SELECT * FROM funded WHERE userid='".$_SESSION['userid']."' ORDER BY year DESC ";
...
if(!$row){
    ...
    <div class="top_navbar">
      ...
      <div class="top_menu">
        <div class="logo">Funded Projects</div>
        <!-- <ul>
          <li><a href="#">
     ...
     <ul>
       ...
       <ul class="dropdown-menu" >
         ...
         <li><a style="color:blue;" class="dropdown-item" href="#">Funded Projects</a></li>
  ...
  <a href="fill_funded.php" class="backk-to-top"><i class="fa fa-plus"></i></a>
  </div>
  </div>
  ';
} else {
...
<a data-toggle="modal" data-target="#exampleModal" href="#" class="btn btn-primary" >Want to fetch funded project  details during specific period?</a>
</div></div></div>
</div>
';
...
<head>
    ...
    <title>Funded Projects | CSE</title>
...
function getid(e){
  ...
  window.location.href="edit_funded.php?w1=" +id ;
}

function getdata(){
  var from_date = document.getElementById('from_date').value;
  var to_date = document.getElementById('to_date').value;
  window.location.href="fetch_funded.php?w1=" +from_date+"&w2=" +to_date ;
}
