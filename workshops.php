...
include 'config.php';
$query = "SELECT * FROM workshops WHERE userid='".$_SESSION['userid']."' ORDER BY year DESC ";
...
if($rows == 0){
    ...
    <div class="top_navbar">
     ...
     <li class="nav-item dropdown">
       ...
       <ul class="dropdown-menu" >
         <li><a style="color:blue;" class="dropdown-item" href="#">Workshop</a></li>
  ...
  <div class="container text-center"><h2>You have no records!..Please fill your Workshops details</h2>
  </div>
  <a href="fill_workshop.php" class="backk-to-top"><i class="fa fa-plus"></i></a>
  </div>
  </div>';
} else {
   echo '<div class="wrapper">
 ...
 <table class="table ">
  ...
  foreach($result as $row){
      ...
      <td>'; if($row['file']== ''){
        ...
        echo '<a href="files/'.$row["file"].'" class="btn btn-info"  download>Download&nbsp;<i class="fa fa-download"></i></a>';  
      }
...
<a data-toggle="modal" data-target="#exampleModal" href="#" class="btn btn-primary" >Want to fetch attended workshop details during specific period?</a>
</div></div><div>
</div>
';
...
<head>
    ...
    <title>Attended Workshops | CSE</title>
...
function getid(e){
  ...
  window.location.href="edit_workshop.php?w1=" +id ;
}

function getdata(){
  var from_date = document.getElementById('from_date').value;
  var to_date = document.getElementById('to_date').value;
  window.location.href="fetch_workshop.php?w1=" +from_date+"&w2=" +to_date ;
}
