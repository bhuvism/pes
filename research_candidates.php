...
include 'config.php';
$query = "SELECT * FROM rcandidates WHERE userid='".$_SESSION['userid']."' ORDER BY reg_year DESC ";
...
if(!$row){
    ...
    <div class="top_navbar">
      ...
      <div class="top_menu">
        <div class="logo">Research Candidates</div>
        <!-- <ul>
          <li><a href="#">
     ...
     <li class="nav-item dropdown">
       ...
       <li>  <a style="color:black;" class="dropdown-item" href="papers.php">Papers / Publications</a></li>
         <li><a style="color:blue;" class="dropdown-item" href="#">Research Candidates</a></li>
  ...
  <div class="container text-center"><h2>You have no records!..Please fill your Research Candidates details</h2>
  </div>
  <a href="fill_rcandidates.php" class="backk-to-top"><i class="fa fa-plus"></i></a>
  </div>
  </div>';
} else {
   echo '<div class="wrapper">
...
<a data-toggle="modal" data-target="#exampleModal" href="#" class="btn btn-primary" >Want to fetch research candidates details during specific period?</a>
</div></div></div>
</div>
';
...
<head>
    ...
    <title>Research Candidates | CSE</title>
...
function getid(e){
  ...
  window.location.href="edit_rcandidates.php?w1=" +id ;
}

function getdata(){
  var from_date = document.getElementById('from_date').value;
  var to_date = document.getElementById('to_date').value;
  window.location.href="fetch_rcandidates.php?w1=" +from_date+"&w2=" +to_date ;
}
