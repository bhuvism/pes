...
include 'config.php';
$query = "SELECT * FROM invite_talks WHERE userid='".$_SESSION['userid']."' ORDER BY year DESC ";
...
if($rows == 0){
    ...
    <div class="top_navbar">
      ...
      <div class="top_menu">
        <div class="logo">Invite Talks</div>
        <!-- <ul>
          <li><a href="#">
     ...
     <li class="nav-item dropdown">
       ...
       <ul class="dropdown-menu" >
         ...
         <li><a style="color:blue;" class="dropdown-item" href="#">Invite Talks</a></li>
  ...
  <div class="container text-center"><h2>You have no records!..Please fill your Invite Talks details</h2>
  </div>
  <a href="fill_invite_talks.php" class="backk-to-top"><i class="fa fa-plus"></i></a>
  </div>
  </div>';
} else {
   echo '<div class="wrapper">
...
<a data-toggle="modal" data-target="#exampleModal" href="#" class="btn btn-primary" >Want to fetch attended invite talks details during specific period?</a>
</div></div><div>
</div>
';
...
function getid(e){
  ...
  window.location.href="edit_invite_talks.php?w1=" +id ;
}

function getdata(){
  var from_date = document.getElementById('from_date').value;
  var to_date = document.getElementById('to_date').value;
  window.location.href="fetch_invite_talks.php?w1=" +from_date+"&w2=" +to_date ;
}
