...
include 'config.php';
$query = "SELECT * FROM teaching WHERE userid='".$_SESSION['userid']."' ORDER BY year DESC ";
...
if(!$row){
  ...
  <a href="fill_teaching.php" class="backk-to-top"><i class="fa fa-plus"></i></a>
  </div>
  </div>
  ';
...
<a data-toggle="modal" data-target="#exampleModal" href="#" class="btn btn-primary" >Want to fetch teaching details during specific period?</a>
</div></div></div>
</div>
</div>
';
